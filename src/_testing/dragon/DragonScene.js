  ...
  return (
    <group position={[0, 0, -5]} ref={ref}>
      {[...Array(TREES_NB)].map((_v, index) => (
        <MovingItem
          key={index}
          position={[-OFFSET_X + (index / TREES_NB) * OFFSET_X * 2, -1.6, -3]}
          randomizePosition
          randomizeScale
        >
      ...
      {[...Array(TREES_NB)].map((_v, index) => (
        <MovingItem
          key={index}
          position={[-OFFSET_X + (index / TREES_NB) * OFFSET_X * 2, -1.6, -1.5]}
          randomizePosition
          randomizeScale
        >
      ...
      {[...Array(TREES_NB)].map((_v, index) => (
        <MovingItem
          key={index}
          position={[
            -OFFSET_X + (index / SM_TREES_NB) * OFFSET_X * 2,
            -1.6,
            0.5,
          ]}
          randomizePosition
      ...
      {[...Array(CLOUDS_NB)].map((_v, index) => (
        <MovingItem
          key={index}
          position={[-OFFSET_X + (index / TREES_NB) * OFFSET_X * 2, 3, -7]}
          randomizePosition
          randomizeScale
        >
