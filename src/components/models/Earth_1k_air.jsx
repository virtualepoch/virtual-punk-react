...
Command: npx gltfjsx@6.1.4 public/models/earth_1k_air.glb -o Earth1KAir
...
export function Earth1K(props) {
  const { nodes, materials } = useGLTF('/models/earth_1k_air.glb')
  return (
...
useGLTF.preload('/models/earth_1k_air.glb')
