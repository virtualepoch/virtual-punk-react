...
Command: npx gltfjsx@6.1.4 public/models/earth_4k_air.glb
...
export function Earth4K(props) {
  const { nodes, materials } = useGLTF('/models/earth_4k_air.glb')
  return (
...
useGLTF.preload('/models/earth_4k_air.glb')
