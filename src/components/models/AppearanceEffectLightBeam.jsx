...
Command: npx gltfjsx@6.2.15 public/models/appearance_effect_light_beam.glb 
...
export function AppearanceEffectLightBeam({ props, start, hubLinkClicked }) {
  ...
  useEffect(() => {
    ...
    mixer.timeScale = start || hubLinkClicked ? 3 : 0;
  }, [actions, mixer, start, hubLinkClicked]);
          ...
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group name="Xingguang_0">
                ...
                <group
                  name="Xingguang_(1)_55"
                  position={[0.021, 0, 0.001]}
                  rotation={[0, 0.92, 0]}
                  scale={0.709}
                >
                ...
                <group
                  name="Xingguang_(2)_103"
                  position={[-0.012, 0, -0.022]}
