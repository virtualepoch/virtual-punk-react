...
export const hubCredits = [
  {
    ...
    title:
      "Detail of a futuristic machine. 3D illustration of a futuristic wall made of various details under orange neon lights. Cyberpunk background. Industrial wallpaper. Grunge details",
