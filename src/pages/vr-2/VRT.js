        ...
        <Suspense fallback={null}>
          ...
          <XR>
            ...
            <mesh position-z={-1}>
              ...
              {visibleItem === "elf" && <Elf position={[0, 0.6, 0.2]} rotation={[0, 0, 0]} scale={0.05} dissolveVisible={itemsDisplayed === "elf"} onFadeOut={onFadeOut} />}

              {visibleItem === "girl-blob" && <GirlBlob position={[0, 0.6, 0.2]} rotation={[0, 0, 0]} scale={0.05} dissolveVisible={itemsDisplayed === "girl-blob"} onFadeOut={onFadeOut} />}
              
              {visibleItem === "pan" && <Pan position={[0, 0.6, 0.2]} rotation={[0, 0, 0]} scale={0.05} dissolveVisible={itemsDisplayed === "pan"} onFadeOut={onFadeOut} />}
            </mesh>
          </XR>
        </Suspense>
      </Canvas>
